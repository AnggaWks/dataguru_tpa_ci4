        ...
        <div class="col-8">
            ...
            <form action="/guru/save" method="post" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control <?= ($validation->hasError('nama_guru')) ? 'is-invalid' : ''; ?>" id="nama_guru" name="nama_guru" autofocus value="<?= old('nama_guru'); ?>">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control <?= ($validation->hasError('tmplahir')) ? 'is-invalid' : ''; ?>" id="tmplahir" name="tmplahir" value="<?= old('tmplahir'); ?>">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="tlahir" name="tlahir" value="<?= old('tlahir'); ?>">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="pterakhir" class="col-sm-2 col-form-label">Pendidikan Terakhir</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="pterakhir" name="pterakhir" value="<?= old('pterakhir'); ?>">
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="kmengajar" name="kmengajar" value="<?= old('kmengajar'); ?>">
                    </div>
                </div>
                <div class="row mb-3">
